-- =============================================
-- RECOMMENDATION SYSTEM FUNCTIONS (FIXED FOR EXISTING SCHEMA)
-- =============================================
...
BEGIN
    ...
    LEFT JOIN user_prefs up ON l.category_id = up.category_id
...
BEGIN
    ...
    AND l.category_id = v_listing.category_id
