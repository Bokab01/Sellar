  ...
  const createListing = async () => {
    ...
    try {
      ...
      const categoryMapping: Record<string, string> = {
        ...
        'furniture': '00000000-0000-4000-8000-000000000003',
        'appliances': '00000000-0000-4000-8000-000000000003',
        'decor': '00000000-0000-4000-8000-000000000003',
        'garden': '00000000-0000-4000-8000-000000000003',
        'tools': '00000000-0000-4000-8000-000000000003',
        
        // Vehicles subcategories
        'cars': '00000000-0000-4000-8000-000000000004',
        'motorcycles': '00000000-0000-4000-8000-000000000004',
        'bicycles': '00000000-0000-4000-8000-000000000004',
        'parts': '00000000-0000-4000-8000-000000000004',
