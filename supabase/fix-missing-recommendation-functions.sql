-- =============================================
-- FIX MISSING RECOMMENDATION FUNCTIONS
-- =============================================

-- Check if functions exist and recreate them if missing
-- This script ensures all recommendation system functions are properly created
