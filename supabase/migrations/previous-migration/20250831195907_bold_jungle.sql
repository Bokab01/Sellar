/*
  ...
  1. New Tables
    ...
    - `offers` - Price offers made through chat
      ...
      - `expires_at` (timestamptz, default 3 days)
      - `parent_offer_id` (uuid, optional for counter offers)
      - `created_at` (timestamptz)
      - `updated_at` (timestamptz)
  ...
  2. Security
    ...
    - Users can only create offers for listings they don't own
*/
