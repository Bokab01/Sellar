-- =============================================
-- SIMPLE RLS POLICIES - FALLBACK VERSION
-- This version uses only basic columns that definitely exist
-- =============================================
...
-- Policy 1: Users can view all profiles (simple version)
...
-- Drop existing policies
DROP POLICY IF EXISTS "Users can view related offers" ON offers;
DROP POLICY IF EXISTS "Users can create offers" ON offers;
DROP POLICY IF EXISTS "Users can update related offers" ON offers;
