-- Content Moderation System Database Schema (Final Fixed Version)
-- This migration adds comprehensive moderation capabilities
-- Fixed to properly handle column creation before foreign key constraints
...
-- Create moderation_logs table with proper column definitions
...
-- Create reports table with proper column definitions
...
-- Create user_reputation table with proper column definitions
...
-- Create keyword_blacklist table with proper column definitions
...
-- Now add foreign key constraints step by step with proper error handling
DO $$
DECLARE
    listings_exists BOOLEAN := FALSE;
    profiles_exists BOOLEAN := FALSE;
BEGIN
    -- Check if tables exist
    SELECT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'listings') INTO listings_exists;
    SELECT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'profiles') INTO profiles_exists;
    
    -- Add foreign key constraints for moderation_logs
    IF listings_exists THEN
        -- Check if listing_id column exists and constraint doesn't exist
        IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'moderation_logs' AND column_name = 'listing_id') 
           AND NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'moderation_logs_listing_id_fkey') THEN
            ALTER TABLE moderation_logs ADD CONSTRAINT moderation_logs_listing_id_fkey 
    ...
    IF profiles_exists THEN
        ...
        IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'moderation_logs' AND column_name = 'user_id') 
           AND NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'moderation_logs_user_id_fkey') THEN
            ALTER TABLE moderation_logs ADD CONSTRAINT moderation_logs_user_id_fkey 
            FOREIGN KEY (user_id) REFERENCES profiles(id) ON DELETE CASCADE;
        END IF;
        
        -- Add moderator_id constraint
        IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'moderation_logs' AND column_name = 'moderator_id') 
           AND NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'moderation_logs_moderator_id_fkey') THEN
            ALTER TABLE moderation_logs ADD CONSTRAINT moderation_logs_moderator_id_fkey 
    ...
    IF listings_exists THEN
        IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'reports' AND column_name = 'listing_id') 
           AND NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'reports_listing_id_fkey') THEN
            ALTER TABLE reports ADD CONSTRAINT reports_listing_id_fkey 
            FOREIGN KEY (listing_id) REFERENCES listings(id) ON DELETE CASCADE;
        END IF;
    END IF;

    IF profiles_exists THEN
        -- Add reporter_id constraint
        IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'reports' AND column_name = 'reporter_id') 
           AND NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'reports_reporter_id_fkey') THEN
        ...
        -- Add reported_user_id constraint
        IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'reports' AND column_name = 'reported_user_id') 
           AND NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'reports_reported_user_id_fkey') THEN
        ...
        IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'reports' AND column_name = 'resolved_by') 
           AND NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'reports_resolved_by_fkey') THEN
            ALTER TABLE reports ADD CONSTRAINT reports_resolved_by_fkey 
            FOREIGN KEY (resolved_by) REFERENCES profiles(id);
        END IF;
    END IF;

    -- Add foreign key constraints for user_reputation
    IF profiles_exists THEN
        IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'user_reputation' AND column_name = 'user_id') 
           AND NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'user_reputation_user_id_fkey') THEN
            ALTER TABLE user_reputation ADD CONSTRAINT user_reputation_user_id_fkey 
            FOREIGN KEY (user_id) REFERENCES profiles(id) ON DELETE CASCADE;
        END IF;
    END IF;

    -- Add foreign key constraints for keyword_blacklist
    IF profiles_exists THEN
        IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'keyword_blacklist' AND column_name = 'created_by') 
           AND NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'keyword_blacklist_created_by_fkey') THEN
...
EXCEPTION
    WHEN OTHERS THEN
        ...
        -- Continue execution even if foreign key constraints fail
END $$;
...
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'listings') THEN
        ...
        IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'listings' AND column_name = 'moderation_score') THEN
            ALTER TABLE listings ADD COLUMN moderation_score DECIMAL(3,2) DEFAULT 0.00;
        END IF;
        
        IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'listings' AND column_name = 'flagged_reasons') THEN
            ALTER TABLE listings ADD COLUMN flagged_reasons TEXT[];
        END IF;
        
        IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'listings' AND column_name = 'auto_moderated_at') THEN
        ...
        IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'listings' AND column_name = 'admin_reviewed_by') THEN
            ...
            IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'profiles') THEN
                ...
                EXCEPTION
                    WHEN OTHERS THEN
                        RAISE NOTICE 'Could not add foreign key constraint for listings.admin_reviewed_by: %', SQLERRM;
                END;
            END IF;
        END IF;
    END IF;
...
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'profiles') THEN
        ...
        IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'profiles' AND column_name = 'moderation_notes') THEN
...
-- Add indexes to existing tables if they exist
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'listings') THEN
...
BEGIN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Could not create moderation_logs user policy: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Could not create moderation_logs admin policy: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Could not create reports insert policy: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Could not create reports user policy: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Could not create reports admin policy: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Could not create user_reputation user policy: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Could not create user_reputation public policy: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Could not create user_reputation admin policy: %', SQLERRM;
    END;

    -- Keyword blacklist policies
    BEGIN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Could not create keyword_blacklist admin policy: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Could not create moderation_categories public policy: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Could not create moderation_categories admin policy: %', SQLERRM;
    END;
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE NOTICE 'Could not initialize user reputation: %', SQLERRM;
END $$;
...
DO $$
BEGIN
    RAISE NOTICE 'Content moderation system migration completed successfully!';
    RAISE NOTICE 'Created tables: moderation_categories, moderation_logs, reports, user_reputation, keyword_blacklist';
    RAISE NOTICE 'Added % moderation categories', (SELECT COUNT(*) FROM moderation_categories);
    RAISE NOTICE 'Added % blacklisted keywords', (SELECT COUNT(*) FROM keyword_blacklist);
END $$;
